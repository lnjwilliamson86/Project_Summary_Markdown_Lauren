...
```
Statistical Analysis of the results data shows: something.... I need to do some analysis on the results data. Initally i was thinking of doing a difference between the two means for each of the control samples. 
...
```{r splot, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="Yet another gapminder plot"}
gapminder %>% 
  filter(year == 1987) %>% 
